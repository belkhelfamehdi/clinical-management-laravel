<template>
  <div>
    <div class="flex justify-between items-center mb-8">
      <div>
        <h1 class="text-2xl font-semibold text-[#1d1d1f]">New Employee</h1>
        <p class="text-[13px] text-[#86868b] mt-1">Register a new employee</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-[#e5e5e7] p-8">
      <form @submit.prevent="submit">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label class="block text-[13px] font-medium text-[#1d1d1f] mb-2">Hire Date</label>
            <input v-model="form.dateem" type="date" class="w-full px-4 py-2.5 bg-[#f5f5f7] border-0 rounded-lg text-[13px] text-[#1d1d1f] outline-none focus:ring-2 focus:ring-[#0071e3]/20" required>
          </div>
          ...
          <div>
            <label class="block text-[13px] font-medium text-[#1d1d1f] mb-2">Role</label>
            <input v-model="form.fonction" type="text" class="w-full px-4 py-2.5 bg-[#f5f5f7] border-0 rounded-lg text-[13px] text-[#1d1d1f] outline-none focus:ring-2 focus:ring-[#0071e3]/20" placeholder="Doctor, Nurse, etc.">
          </div>
        </div>
        ...
        <div class="flex items-center gap-3 mt-8 pt-6 border-t border-[#e5e5e7]">
          ...
          <a href="/employees" class="text-[13px] text-[#86868b] hover:text-[#1d1d1f] transition-colors font-medium">Cancel</a>
        </div>
      </form>
    </div>
  </div>
